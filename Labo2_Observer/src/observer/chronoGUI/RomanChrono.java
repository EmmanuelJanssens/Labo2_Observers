...
public class RomanChrono extends AnalogChrono{
    public RomanChrono(Chrono chrono, String name) {
        ...
        img = Toolkit.getDefaultToolkit().getImage("images/cadran_chiffres_romains.jpg").getScaledInstance(getPreferredSize().width,getPreferredSize().height, Image.SCALE_DEFAULT);
    }
}
